...
CREATE TABLE IF NOT EXISTS `retardos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `empleado_id` int(11) NOT NULL,
  `zk_empleado_id_original` varchar(50) DEFAULT NULL,
  `fecha` date NOT NULL,
  ...
  `unique_dia_empleado` varchar(50) DEFAULT NULL,
  `minutos_retardo` int(11) NOT NULL DEFAULT 0,
  ...
  `evidencia_adjunta` varchar(255) DEFAULT NULL,
