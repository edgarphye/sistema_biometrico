...
## Purpose
Generar reportes en formato Excel (.xlsx) con PhpSpreadsheet para asistencia, retardos, justificaciones, comisiones y sanciones, con filtros avanzados y exportación desde el frontend.
