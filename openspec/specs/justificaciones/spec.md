...
## Purpose
Gestionar la justificación de retardos, faltas e incidencias con registro de evidencias, flujo de aprobación por jefe o RH y seguimiento de modificaciones en la bitácora de auditoría.
...
El sistema SHALL registrar cambios a justificaciones en modificaciones_justificacion con tabla_origen, registro_id, campo_modificado, valor_anterior, valor_nuevo, modificado_por, y estatus de validación del cambio.
...
- **auditoria-modificaciones-justificacion** — Sub-sistema completo de auditoría con modelo `ModificacionJustificacion` (223 lines), API dedicada (`api/modificaciones_justificacion.php`), y migraciones específicas. Gestiona el ciclo de vida de cada modificación con estatus pendiente/aprobado/rechazado y requiere validación de jefe o RH
