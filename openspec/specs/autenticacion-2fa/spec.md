...
## Purpose
Reforzar la seguridad del inicio de sesión mediante autenticación de dos factores con TOTP, email y SMS, configurable por usuario y con almacenamiento seguro de secretos.
