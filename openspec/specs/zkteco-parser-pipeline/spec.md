...
El sistema SHALL registrar el procesamiento de cada archivo .dat en `logs_dispositivo_zk` con resultado, registros procesados, errores y tiempo de procesamiento, y exponer la vista de logs del dispositivo cargando `ZKTecoLogProcessor` desde `models/`.
