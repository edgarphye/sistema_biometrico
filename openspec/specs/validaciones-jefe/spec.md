...
## Purpose
Gestionar el flujo de validación jefe-subordinado para retardos, comisiones, días económicos y ausencias, con comunicación bidireccional, validación masiva, contador de pendientes y auto-procesamiento por vencimiento.
...
- **mensajes-validacion** (`openspec/specs/mensajes-validacion/`) — Spec dedicado para el sistema de mensajería bidireccional empleado-jefe dentro del flujo de validación, con rutas `/validaciones/mensajes/*`, archivos adjuntos, estados de lectura y contador de no leídos
