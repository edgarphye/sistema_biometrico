...
## Purpose
Administrar el catálogo de sanciones con tipos parametrizables (suspensión, amonestación, nota mala, descuento, acta administrativa), seguimiento de estado y consulta histórica por empleado.
