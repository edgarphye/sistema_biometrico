...
## Purpose
Exponer métricas de aplicación y negocio para Prometheus, proveer dashboards Grafana con paneles de estado del sistema y configurar alertas para detección temprana de anomalías.
