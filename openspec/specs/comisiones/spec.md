...
## Purpose
Gestionar el registro, validación y aprobación de comisiones con límites AEFCM de monto y días, tipos parametrizables y flujo de aprobación pendiente/aprobada/rechazada.
