<?php
// dashboard_standalone.php - Dashboard robusto sin errores
...
<body>
    ...
    <nav class="sidebar">
        ...
        <div class="nav flex-column">
            ...
            <a href="empleados_standalone.php" class="nav-link">
        ...
        <div class="user-info">
            <div class="text-center">
                <div class="bg-white text-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-2" 
                    ...
                    <strong><?= $session_first_letter ?></strong>
                </div>
                <div><strong><?= $session_username ?></strong></div>
                <div class="small opacity-75"><?= $session_rol ?></div>
                <a href="logout_standalone.php" class="btn btn-sm btn-outline-light mt-3 w-100">
    ...
    <main class="main-content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <a href="empleados_standalone.php" class="quick-action card text-primary h-100 text-decoration-none">
                        ...
                        <div class="timeline">
                            <div class="d-flex mb-3 p-3 bg-light rounded">
                                ...
                                <div>
                                    ...
                                    <br>
                                    <small class="text-muted">Hace 2 horas por <?= $session_username ?></small>
                                </div>
                            </div>
                            <div class="d-flex mb-3 p-3 bg-light rounded">
