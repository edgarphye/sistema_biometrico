...
try {
    // Usar las funciones generarRFC y generarCURP del helper
    $rfcGenerado = RfcCurpHelper::generarRFC($nombres, $primerApellido, $segundoApellido, $fechaNacimiento);
    $curpGenerado = RfcCurpHelper::generarCURP($nombres, $primerApellido, $segundoApellido, $fechaNacimiento, $sexo, $entidadFederativa);
