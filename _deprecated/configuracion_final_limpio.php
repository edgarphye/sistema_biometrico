...
try {
    ...
    foreach ($empleados as $empleado) {
        ...
        $sql = "INSERT INTO empleados (nombre, apellido, area, jerarquia, activo, jefe_directo_id, fecha_nacimiento, sexo, entidad_federativa) 
                VALUES (?, ?, ?, ?, 1, ?, ?, ?, ?, ?)";
    ...
    echo "\n📋 PASOS PARA PROBAR:\n";
    echo "   1. Inicie sesión con uno de los jefes listados arriba\n";
    echo "   2. Acceda a: /validaciones\n";
    echo "   3. Verá la lista de empleados a cargo en cards interactivos\n";
