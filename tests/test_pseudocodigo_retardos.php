...
class TestPseudocodigoRetardos extends TestCase {
    private $db;
    private $pdo;
    ...
    public function testClasificacionRetardoSegunPseudocodigo() {
        ...
        // Test tolerancia (1-10 min) y justificación (>30 min)
        ...
        $this->assertEquals('justificacion', $retardo['tipo'], 'Retardo de 35 min debería requerir justificacion');
    }
    ...
    public function testRegistroEntradaConLogicaPseudocodigo() {
