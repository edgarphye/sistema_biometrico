...
echo "=== PRUEBA MANUAL: Flujo de Retardos ===\n\n";
...
// Test clasificación de retardos
echo "4. Probando clasificación de retardos...\n";
$test_cases = [
...
echo "6. Probando registro de entrada con lógica completa de retardos...\n";
